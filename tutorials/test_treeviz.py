...
flags.DEFINE_string(
    "out", "/tmp/gametree.png", "Name of output file, e.g., " "[*.png|*.pdf]."
)
...
flags.DEFINE_string(
    "target_pubset", "*", "Limit grouping of public states only to specified state."
)
...
def main(argv):
    ...
    if game_type.dynamics == pyspiel.GameType.Dynamics.SIMULTANEOUS:
        logging.warn(
            "%s is not turn-based. Trying to reload game as turn-based.", FLAGS.game
        )
